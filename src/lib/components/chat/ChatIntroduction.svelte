...
<div class="my-auto grid items-center justify-center gap-8 text-center">
	<div
		class="flex -translate-y-16 select-none items-center rounded-xl text-xl font-medium text-gray-600 dark:text-gray-400 md:-translate-y-12 md:text-2xl"
	>
		<Logo classNames="size-6 md:size-8 dark:invert mr-1" />
